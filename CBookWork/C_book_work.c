// This is simply a file where I put all the work that I complete while going through The Second Edition of C Programming Language - ANSI C by Kernighan and Ritchie
#include <stdio.h>
#include <string.h>
#include <ctype.h>
#include <math.h>
